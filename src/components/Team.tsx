  ...
  return (
    <section id="team" className="py-24 px-6 md:px-12 lg:px-24 bg-gray-50">
      <div className="text-center mb-16">
        ...
        >
          המומחים שלנו כאן כדי ללוות אתכם בכל צעד בדרך לעסקה המושלמת.
        </motion.p>
      </div>
          ...
          >
            <div className="relative overflow-hidden rounded-3xl aspect-[3/4] mb-4">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                <button className="bg-white text-black px-4 py-2 rounded-full text-sm font-medium w-full hover:bg-gray-100 transition-colors">
                  צור קשר
                </button>
              </div>
            </div>
